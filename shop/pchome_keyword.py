...
# '/Users/willy/Documents/python_works/web_crawler/shop/jj2_test/templates/index.html'
# keyword = 'LED數字時鐘'
# keyword = input('PLS input keyword: ') # switch 動物森友會 主機

from shop.jj2_test import my_webapp
keyword = my_webapp.request.form['inputtext']
...
# 寫入MySQL
## 建立資料庫連線
        db = MySQLdb.connect(host='localhost', user='xxxx', passwd='xxxxx', db='shopping', port=3306, charset='utf8mb4')
